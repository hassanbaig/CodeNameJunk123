...
namespace JunkCar.Data
{
    ...
    public partial class shiner49_JunkCarNewEntities : DbContext
    {
        ...
        public virtual int usp_Sal_Customer_Validate(ObjectParameter customer_Id, ObjectParameter login_Password, string customer_Name, string customer_Address, string customer_Phone, string customer_Email, string zip_Code, ObjectParameter sign_Up, Nullable<int> password_Question_Id, string password_Answer)
        {
            var customer_NameParameter = customer_Name != null ?
                new ObjectParameter("Customer_Name", customer_Name) :
                new ObjectParameter("Customer_Name", typeof(string));
            ...
            var password_Question_IdParameter = password_Question_Id.HasValue ?
                new ObjectParameter("Password_Question_Id", password_Question_Id) :
                new ObjectParameter("Password_Question_Id", typeof(int));
    
            var password_AnswerParameter = password_Answer != null ?
                new ObjectParameter("Password_Answer", password_Answer) :
                new ObjectParameter("Password_Answer", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_Sal_Customer_Validate", customer_Id, login_Password, customer_NameParameter, customer_AddressParameter, customer_PhoneParameter, customer_EmailParameter, zip_CodeParameter, sign_Up, password_Question_IdParameter, password_AnswerParameter);
        }
    
        public virtual ObjectResult<usp_Sal_Customer_Signup_Result> usp_Sal_Customer_Signup(Nullable<int> customer_Id, string login_Password, string customer_Name, string customer_Address, string customer_Phone, string customer_Email, string zip_Code, Nullable<int> sign_Up, Nullable<int> password_Question_Id, string password_Answer)
        {
            var customer_IdParameter = customer_Id.HasValue ?
                new ObjectParameter("Customer_Id", customer_Id) :
                new ObjectParameter("Customer_Id", typeof(int));
            ...
            var sign_UpParameter = sign_Up.HasValue ?
                ...
                new ObjectParameter("Sign_Up", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_Sal_Customer_Signup_Result>("usp_Sal_Customer_Signup", customer_IdParameter, login_PasswordParameter, customer_NameParameter, customer_AddressParameter, customer_PhoneParameter, customer_EmailParameter, zip_CodeParameter, sign_UpParameter, password_Question_IdParameter, password_AnswerParameter);
        }
        ...
        public virtual ObjectResult<RegisterUser_Result> RegisterUser(Nullable<int> customer_Id, string login_Password, string customer_Name, string customer_Address, string customer_Phone, string customer_Email, string zip_Code, Nullable<int> sign_Up, Nullable<int> password_Question_Id, string password_Answer)
        {
            var customer_IdParameter = customer_Id.HasValue ?
                new ObjectParameter("Customer_Id", customer_Id) :
                new ObjectParameter("Customer_Id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<RegisterUser_Result>("RegisterUser", customer_IdParameter, login_PasswordParameter, customer_NameParameter, customer_AddressParameter, customer_PhoneParameter, customer_EmailParameter, zip_CodeParameter, sign_UpParameter, password_Question_IdParameter, password_AnswerParameter);
        }
    
        public virtual ObjectResult<RegisterUser_Result> Authenticate(Nullable<int> customer_Id, string login_Password, string customer_Name, string customer_Address, string customer_Phone, string customer_Email, string zip_Code, Nullable<int> sign_Up, Nullable<int> password_Question_Id, string password_Answer)
        {
            var customer_IdParameter = customer_Id.HasValue ?
                new ObjectParameter("Customer_Id", customer_Id) :
                new ObjectParameter("Customer_Id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<RegisterUser_Result>("Authenticate", customer_IdParameter, login_PasswordParameter, customer_NameParameter, customer_AddressParameter, customer_PhoneParameter, customer_EmailParameter, zip_CodeParameter, sign_UpParameter, password_Question_IdParameter, password_AnswerParameter);
        }
    }
}
