...
(function () {
    ...
    var serviceId = 'entityManagerFactoryPractices';
    angular.module('app')
    ...
    function emFactory(breeze) {
        ...
        //var serviceName = 'http://localhost:5555' + '/JunkCar/v1/';

        var serviceName = 'http://localhost/JunkCarwebapi' + '/JunkCar/v1/Practices';
