...
public class usp_Set_Zip_Code_Result {
    ...
    private String Acceptable_Cities;
    private String Unacceptable_Cities;
    ...
    public usp_Set_Zip_Code_Result() {
    ...
    public boolean isIs_Decommissioned() {
